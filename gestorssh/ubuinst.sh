...
wget https://github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/gestorssh18.zip > /dev/null 2>&1
...
function inst_db { 
cd || exit
wget https://github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
function tst_bkp {
cd /bin || exit
wget https://github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/userteste.sh
wget https://github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/autobackup.sh
