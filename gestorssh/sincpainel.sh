...
wget github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/sshplus.zip.001 > /dev/null 2>&1
wget github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/sshplus.zip.002 > /dev/null 2>&1
wget github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/sincpainel.zip > /dev/null 2>&1
