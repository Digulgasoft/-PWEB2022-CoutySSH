...
wget https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/uteste > /bin/usersteste.sh
wget -qO- https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/backupauto > /bin/autobackup.sh
