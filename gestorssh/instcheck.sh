...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/chuser > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/checkuser.py > /dev/null 2>&1
