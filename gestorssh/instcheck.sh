...
sleep 5
cd /bin || exit
wget https://github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/CoutySSH/PWEB2022/raw/ntech/gestorssh/checkuser.py > /dev/null 2>&1
